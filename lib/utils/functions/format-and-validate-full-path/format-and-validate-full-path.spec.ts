...
describe('formatAndValidateFullPath Function', () => {
  ...
  describe('rootDirectoryName parameter', () => {
    ...
    it('should throw an error when it is an empty string', () => {
      expect(() => formatAndValidateFullPath('fullPath', '')).toThrow('rootDirectoryName parameter was not provided');
    });
  });
  ...
  it('should return fullPath with prefix when validation passed', () => {
    expect(formatAndValidateFullPath('dir1/filename.ext', 'root')).toEqual('root/dir1/filename.ext');

    expect(formatAndValidateFullPath('dir1/dir2/filename.ext', 'root')).toEqual('root/dir1/dir2/filename.ext');
  });
